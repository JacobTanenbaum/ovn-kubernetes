	...
	tests := []struct {
	...
	}{
		{
			...
			dnsOpsMockHelper: []ovntest.TestifyMockHelper{
				...
				{"Fqdn", []string{"string"}, []interface{}{"www.test.com"}},
				{"Exchange", []string{"*dns.Client", "*dns.Msg", "string"}, []interface{}{nil, 0 * time.Second, fmt.Errorf("mock error")}},
			},
		},
		{
			...
			dnsOpsMockHelper: []ovntest.TestifyMockHelper{
				{"SetQuestion", []string{"*dns.Msg", "string", "uint16"}, []interface{}{&dns.Msg{}}},
				{"Fqdn", []string{"string"}, []interface{}{"www.test.com"}},
				{"Exchange", []string{"*dns.Client", "*dns.Msg", "string"}, []interface{}{&dns.Msg{MsgHdr: dns.MsgHdr{Rcode: 2}}, 0 * time.Second, nil}},
			},
		},
	}
...
func TestUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			dnsOpsMockHelper: []ovntest.TestifyMockHelper{
				{"Fqdn", []string{"string"}, []interface{}{dnsName}},
				{"SetQuestion", []string{"*dns.Msg", "string", "uint16"}, []interface{}{&dns.Msg{}}},
				{"Exchange", []string{"*dns.Client", "*dns.Msg", "string"}, []interface{}{nil, 0 * time.Second, fmt.Errorf("mock error")}},
			},
			errExp: true,
		},
		{
			...
			dnsOpsMockHelper: []ovntest.TestifyMockHelper{
				{"Fqdn", []string{"string"}, []interface{}{dnsName}},
				{"SetQuestion", []string{"*dns.Msg", "string", "uint16"}, []interface{}{&dns.Msg{}}},
				{"Exchange", []string{"*dns.Client", "*dns.Msg", "string"}, []interface{}{&dns.Msg{MsgHdr: dns.MsgHdr{Rcode: dns.RcodeSuccess}, Answer: []dns.RR{&dns.A{A: newIP}}}, 0 * time.Second, nil}},
			},
			errExp:    false,
			changeExp: false,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			dnsOpsMockHelper: []ovntest.TestifyMockHelper{
				{"Fqdn", []string{"string"}, []interface{}{dnsName}},
				{"SetQuestion", []string{"*dns.Msg", "string", "uint16"}, []interface{}{&dns.Msg{}}},
				{"Exchange", []string{"*dns.Client", "*dns.Msg", "string"}, []interface{}{&dns.Msg{MsgHdr: dns.MsgHdr{Rcode: dns.RcodeSuccess}, Answer: []dns.RR{}}, 0 * time.Second, nil}},
			},
		},
		{
			desc:   "Add succeeds ",
			...
			dnsOpsMockHelper: []ovntest.TestifyMockHelper{
				{"Fqdn", []string{"string"}, []interface{}{dnsName}},
				{"SetQuestion", []string{"*dns.Msg", "string", "uint16"}, []interface{}{&dns.Msg{}}},
				{"Exchange", []string{"*dns.Client", "*dns.Msg", "string"}, []interface{}{&dns.Msg{MsgHdr: dns.MsgHdr{Rcode: dns.RcodeSuccess}, Answer: []dns.RR{&dns.A{A: addedIP}}}, 0 * time.Second, nil}},
			},
		},
	}
	for i, tc := range tests {
